...
?>
                                          ...
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="number" min="0" step="0.1" max="2" name="aiomatic_amazon_list[temperature][]" value="" placeholder="1" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="0" max="1" step="0.1" name="aiomatic_amazon_list[top_p][]" value="" placeholder="1" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="-2" step="0.1" max="2" name="aiomatic_amazon_list[presence_penalty][]" value="" placeholder="0" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="0" max="2" step="0.1" name="aiomatic_amazon_list[frequency_penalty][]" value="" placeholder="0" class="cr_width_full">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="0.1" max="2" name="aiomatic_amazon_list[temperature][]" value="' . esc_attr($temperature) . '" placeholder="1" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="0.1" max="1" name="aiomatic_amazon_list[top_p][]" value="' . esc_attr($top_p) . '" placeholder="1" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="-2" max="2" step="0.1" name="aiomatic_amazon_list[presence_penalty][]" value="' . esc_attr($presence_penalty) . '" placeholder="0" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="-2" step="0.1" max="2" name="aiomatic_amazon_list[frequency_penalty][]" value="' . esc_attr($frequency_penalty) . '" placeholder="0" class="cr_width_full">
